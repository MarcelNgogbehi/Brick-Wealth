...
//
// Reproduces the Brick & Wealth share certificate template VERBATIM.
...
const styles = StyleSheet.create({
  ...
  // Faint full-bleed monogram watermark behind the content
  watermark: {
    position: "absolute",
    top: 150,
    left: 0,
...
function ShareCertificateDoc({
  ...
  return React.createElement(
    Document,
    { title: `Share Certificate ${certificateNumber}`, author: "Brick & Wealth Holdings Ltd" },
    React.createElement(
      Page,
      ...
      React.createElement(Text, { style: styles.watermark, fixed: true }, "B&W"),
      ...
      React.createElement(
        ...
        React.createElement(Text, { style: styles.classLine }, "Ordinary Shares · Issued under the Companies Act 2006"),
        ...
        React.createElement(
          ...
          React.createElement(Text, { style: styles.metaValue }, "Brick & Wealth Holdings Ltd")
        ),
        React.createElement(
          View,
          { style: styles.metaRow },
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            ", which are ",
            React.createElement(Text, { style: styles.bold }, paidStatus),
            ", in Brick & Wealth Holdings Ltd."
          )
        ),
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(Text, { style: styles.signFor }, "For and on behalf of Brick & Wealth Holdings Ltd"),
            React.createElement(
              View,
...
export function buildCertificateFields({ allocation, user, spv }) {
  ...
  return {
    ...
    registeredOffice: process.env.COMPANY_REGISTERED_OFFICE || "London EC2M, United Kingdom",
