  ...
  return (
    <View style={styles.disclaimer}>
      <Text>
        ...
        {" "}It records dividends, subscriptions, transfers and holdings for the period shown and is provided for reference only. Bricks &amp; Wealth Holdings Ltd is not a tax adviser or accountant. Investors are responsible for the correct reporting of their own tax affairs and should consult a qualified professional if in any doubt.
...
function StatementDoc(props) {
  ...
  return (
    <Document title={`Annual Statement ${taxYear} — ${investor.fullName}`} author="Bricks & Wealth Holdings Ltd">
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.pageFooter} fixed>
          <Text>Bricks &amp; Wealth Holdings Ltd · No. 14582930</Text>
