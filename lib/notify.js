...
async function sendNotificationEmail({
  ...
  const fromAddress = process.env.RESEND_FROM_EMAIL || "Brick & Wealth <noreply@brickandwealth.com>";
          ...
          <tr>
            <td style="background:#0A1F44;padding:24px 32px;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td>
                    <div style="font-family:Georgia,'Times New Roman',serif;font-style:italic;font-size:22px;color:#F8F4EC;letter-spacing:-0.01em;">Brick &amp; Wealth</div>
          ...
          <tr>
            <td style="padding:24px 32px;background:#FBF8F1;border-top:1px solid rgba(10,31,68,0.06);">
              ...
              <p style="margin:12px 0 0 0;font-size:11px;color:#8A93A6;">
                Brick &amp; Wealth Holdings Ltd · Companies House No. 14582930<br>
...
export async function notifyWelcomeFirstInvestment({ userId, opportunityTitle }) {
  return notifyUser({
    ...
    body: `Congratulations on your first investment with Brick & Wealth — ${opportunityTitle}. You can track your holdings, download your certificates, and follow property updates from your dashboard. We're glad to have you with us.`,
    link: `/dashboard/holdings`,
    emailSubject: "Welcome to Brick & Wealth",
...
export async function notifySaleRequestReceived({ userId, spvName, requestId, unitsOffered }) {
  return notifyUser({
    ...
    link: `/dashboard/sales?request=${requestId}`,
